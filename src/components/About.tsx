...
const stats = [
  ...
  {
    icon: GraduationCap,
    label: "Dean's List / Magna Cum Laude",
    value: "'22–'26",
  },
];
  ...
  return (
    <motion.section
      ...
      <div className="mx-auto max-w-5xl px-6">
        <SectionHeading
          eyebrow="About"
          title="Builder at heart, learner by default."
        />
        <div className="grid md:grid-cols-5 gap-8 items-start">
          <motion.div
            ...
            <p className="text-lg leading-relaxed text-foreground/85">
              ...
              <span className="text-primary">Centro Escolar University</span>,
              passionate about building full-stack web applications and
              exploring AI to make tools that feel intuitive and genuinely
              useful.
            </p>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              From AI-powered academic forums to barangay management systems, I
              love going end-to-end — shaping schemas, wiring real-time
              backends, designing interfaces, and shipping polished products. I
              thrive on clean code, thoughtful UX, and the small details that
              elevate good work into great work.
            </p>
